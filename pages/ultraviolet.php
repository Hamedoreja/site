...
<main>
    <figure>
        <p><img src="../images/women/ultraviolet.png" alt="Ultraviolet Paco Rabanne" /></p>
        <figcaption>Ultraviolet</figcaption>
    </figure>
    <article>
        ...
        <p>Ultraviolet - аромат адресован сильным, уверенным в себе, эмоциональным, непредсказуемым и загадочным, современным жителям большого города. Духи Ultraviolet - воплощение страсти, женственности и нежности, таинственности. Белый фон символизирует чистоту и близость. Духи Ultraviolet - как символ весны, возрождают красоту, вселяет радость и оптимизм, порождают желание...<p/>
        <ul>
